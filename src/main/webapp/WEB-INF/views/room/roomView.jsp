...
<body>
	...
	<header class="bg-primary text-white p-3 text-end">
		<input type="button" value="Index" class="btn btn-light"
	...
	<div class="container mt-5">
		...
		<div class="amenity-section bg-light p-4 mt-5 rounded">
			<h3>
				<i class="fas fa-dumbbell"></i> 부대시설
			</h3>
			<table class="table">
				<tr>
					<td>
						<h4>
							<i class="fas fa-check-circle"></i> 피트니스 센터 무료 이용
						</h4>
				...
				<tr>
					<td>
						<h4>
							<i class="fas fa-calendar-alt"></i> 피트니스 센터 휴일
						</h4>
						<ul class="list-unstyled">
				...
				<tr>
					<td>
						<h4>
							<i class="fas fa-swimmer"></i> 실내 수영장
						</h4>
						<ul class="list-unstyled">
				...
				<tr>
					<td>
						<h4>
							<i class="fas fa-parking"></i> 무료 주차
						</h4>
						<ul class="list-unstyled">
